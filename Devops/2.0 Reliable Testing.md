...
> What is Reliable? Reliable is the absence of Uncertainty. In order to break this down a little bit, Reliable is the removal of anything that would cause unknown or unaccounted for variance in the testing situation. Therefor Reliable Testing is Tests that run without Uncertainty.
